...
public class ParallelStreamExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sequentialDuration in NanoSecs : " + TimeUnit.NANOSECONDS.toMillis(sequentialDuration));
        ...
        System.out.println("parallelDuration in NanoSecs : " + TimeUnit.NANOSECONDS.toMillis(parallelDuration));
